...
# %% auto 0
__all__ = ['Base_Date_Encodings', 'df_preproc', 'import_log', 'drop_long_traces', 'RandomTraceSplitter', 'split_traces', 'PPObj',
           'PPProc', 'Categorify', 'FillStrategy', 'FillMissing', 'Normalize', 'encode_date', 'decode_date', 'Datetify',
           'MinMax', 'OneHot', 'windows_fast', 'PPDset']
...
# %% ../nbs/01_process.ipynb 25
def _apply_cats (voc, add, c):
    if not is_categorical_dtype(c):
        return pd.Categorical(c, categories=voc[c.name][add:]).codes+add
    return c.cat.codes+add #if is_categorical_dtype(c) else c.map(voc[c.name].o2i)

# %% ../nbs/01_process.ipynb 26
...
# %% ../nbs/01_process.ipynb 60
from sklearn.preprocessing import OneHotEncoder

# %% ../nbs/01_process.ipynb 61
class OneHot(PPProc):
